...
public class HibernateConfiguration {
	...
	static{
		try{
			...
			config.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/company");
			...
			sessionFactory = config.addPackage("com.admin.model.*").addAnnotatedClass(Employee.class).buildSessionFactory(builder.build());
